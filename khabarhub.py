...
latest_news = soup.find_all('div', class_='uk-margin-small-top') 
print(latest_news)
articles_url=[]
...
for each_article_url in articles_url: 
    ...
    title = article_soup.find('div', class_='uk-card').find('h1').get_text(strip=True)
    content_paragraphs = article_soup.find('div', class_='post-entry').find_all('p')
